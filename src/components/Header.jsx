      ...
      <nav className="flex items-center justify-between max-w-[1200px] mx-auto px-8 py-5 md:py-4">
        ...
        <div className="hidden md:flex gap-8 items-center">
          ...
          <motion.a
            ...
            href="#"
            download
            className="ml-6 bg-superred text-white px-5 py-2 rounded-full font-semibold shadow transition hover:bg-white hover:text-superred border-2 border-superred"
          >
            Download Brochure
          </motion.a>
        </div>
